export const translations = {
  en: {
    ...
    settingsLocalLlmUrlHelp: 'Enter the base URL for your local LLM server (e.g. Ollama). Used for RAG, Fine-tuning, and local generation.',
  ...
  de: {
    ...
    settingsLocalLlmUrlHelp: 'Geben Sie die Basis-URL für Ihren lokalen LLM-Server (z.B. Ollama) ein. Dies wird für RAG, Fine-Tuning und lokale Generierung verwendet.',
